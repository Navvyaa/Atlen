                ...
                }
                {
                    ...
                    <>
                        ...
                        <div className="flex flex-row mx-4 gap-16 ml-8 lg:ml-12 no-scrollbar overflow-x-auto h-[250px] scrollbar-hide">
                            {
                                europe.map((destination, index) => (
                                    <div key={index} className="rounded-full w-[140px] flex-shrink-0  ">
                        ...
                        {DestinationGuides.map((place,index)=>(
                            <div 
                            key={index}
                            className="w-[250px] h-full relative rounded-2xl flex-shrink-0"
                            >
                                <img src={place.img} alt="place"  className="object-cover w-full rounded-2xl"/>
                                <div className="absolute bottom-2 w-full text-center">
                        ...
                        <p className="font-semibold text-2xl  ml-8  my-8 ">Explore All Packages</p>
                        <div className="flex flex-row gap-1  ml-6 w-full flex-wrap ">
                        {Array.from({ length: 16 }).map((_, index) => (
                            <button key={index} className="p-3 hover:shadow-xl hover:bg-pink-50  border-pink-800 border w-auto m-1 font-semibold uppercase relative rounded-2xl ">
                                Maldives Package
                            </button>
                        ))}
                        </div>
